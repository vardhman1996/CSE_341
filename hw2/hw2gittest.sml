...
val all_except_option_test1 = remove_option("1", []) = NONE
val all_except_option_test2 = remove_option("1", ["1", "2", "3"]) = SOME(["2", "3"])
val all_except_option_test3 = remove_option("2", ["1", "2", "3"]) = SOME(["1", "3"])
val all_except_option_test4 = remove_option("3", ["1", "2", "3"]) = SOME(["1", "2"])
val all_except_option_test5 = remove_option("4", ["1", "2", "3"]) = NONE

val get_substitutions1_test1 = all_substitutions1([["Fred","Frederick"],["Elizabeth","Betty"],["Freddie","Fred","F"]], "Fred") = ["Frederick","Freddie","F"]
val get_substitutions1_test2 = all_substitutions1([["Fred","Frederick"],["Jeff","Jeffrey"],["Geoff","Jeff","Jeffrey"]], "Jeff") = ["Jeffrey","Geoff","Jeffrey"]

val get_substitutions2_test1 = all_substitutions2([["Fred","Frederick"],["Elizabeth","Betty"],["Freddie","Fred","F"]], "Fred") = ["Frederick","Freddie","F"]
val get_substitutions2_test2 = all_substitutions2([["Fred","Frederick"],["Jeff","Jeffrey"],["Geoff","Jeff","Jeffrey"]], "Jeff") = ["Jeffrey","Geoff","Jeffrey"]
